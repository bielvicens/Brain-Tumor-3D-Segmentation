...
def test_random_crop_preserves_crop_shape(
...
def test_random_crop_probability_zero_returns_original(
    sample: PreprocessingSample,
) -> None:
...
def test_random_crop_larger_than_volume_raises(
    sample: PreprocessingSample,
) -> None:
...
def test_random_crop_invalid_crop_size_raises(
    crop_size,
) -> None:
...
def test_random_crop_preserves_alignment() -> None:
